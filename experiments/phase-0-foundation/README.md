# Phase 0 Foundation - Lane Keeping Baseline
...
Phase 0는 자율주행 ML 플랫폼의 기초(Foundation) 학습으로, 차선 유지(Lane Keeping) 능력을 학습하는 baseline 실험입니다.
...
**Config File:** `config/vehicle_ppo_Phase 0.yaml`
...
├── config/
│   └── vehicle_ppo_Phase 0.yaml   # Training configuration
...
- Config: `python/configs/planning/vehicle_ppo_Phase 0.yaml`
