...
`config/vehicle_ppo_v12_phaseG.yaml`
...
```bash
mlagents-learn python/configs/planning/vehicle_ppo_v12_phaseG.yaml \
  --run-id=v12_phaseG_recovery --force \
  --initialize-from=results/v12_phaseF_recovery/E2EDrivingAgent
```
