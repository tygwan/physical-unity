...
### Configuration
- **vehicle_ppo_v12_phaseA.yaml** - ML-Agents config with 3-stage curriculum
...
Config: `python/configs/planning/vehicle_ppo_v12_phaseA.yaml`
...
Monitor: `tensorboard --logdir=experiments/v12_phaseA_dense_overtaking/logs/`
